...
public class UnisonSymbolyIdImpl extends ASTWrapperPsiElement implements UnisonSymbolyId {

  public UnisonSymbolyIdImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull UnisonVisitor visitor) {
    visitor.visitSymbolyId(this);
  }
